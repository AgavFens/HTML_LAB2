...
var SmartCaptcha = function (props) {
    ...
    var onChallengeHidden = props.onChallengeHidden, onChallengeVisible = props.onChallengeVisible, onSuccess = props.onSuccess, onNetworkError = props.onNetworkError, onTokenExpired = props.onTokenExpired, onJavascriptError = props.onJavascriptError, language = props.language, host = props.host, restProps = __rest(props, ["onChallengeHidden", "onChallengeVisible", "onSuccess", "onNetworkError", "onTokenExpired", "onJavascriptError", "language", "host"]);
    ...
    useIsomorphicLayoutEffect(function () {
        ...
        var id = smartCaptcha.render(containerRef.current, __assign(__assign({}, restProps), { hl: language }));
        setWidgetId(id);
        return function () {
...
var InvisibleSmartCaptcha = function (props) {
    ...
    useIsomorphicLayoutEffect(function () {
        ...
        var id = smartCaptcha.render(containerRef.current, __assign(__assign({}, restProps), { invisible: true, hl: language }));
        setWidgetId(id);
        return function () {
